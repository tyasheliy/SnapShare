            ...
            <div class="cont lg:w-1/2 w-full h-2/3 flex flex-col items-center">
                ...
                <div class="h-2/3">
                    <form @submit.prevent="submit()" class="flex flex-col space-y-2">
                        <div id="messageContainer" ref="messageContainer" class="h-1/3 text-foreground text-center rounded-sm opacity-0 transition-all duration-300 w-full">
                        ...
                        <div class="h-1/3 text-foreground text-center flex-col flex">
                            <button ref="submitButton" class="m-12 rounded-xl p-3 border-2 border-foreground hover:bg-accent focus:bg-accept transition-all duration-150" type="submit">Submit</button>
